# nohup bash src/ms_poe.sh 1 2 > log_ours_1.out 2>&1 &
# nohup bash src/ms_poe.sh 3 3 > log_ours_3.out 2>&1 &

# nohup bash src/ms_poe.sh 5 0 > log_ours_5.out 2>&1 &
nohup bash src/ms_poe.sh 7 2 > log_ours_7.out 2>&1 &
nohup bash src/ms_poe.sh 10 3 > log_ours_10.out 2>&1 &
